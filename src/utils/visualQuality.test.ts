...
describe("visualQuality", () => {
  ...
  it("degrades quality before disabling effects entirely", () => {
    expect(
      degradeVisualProfile({ effectsQuality: "full", dpr: FULL_EFFECTS_MAX_DPR }, false),
    ).toEqual({
      effectsQuality: "reduced",
    ...
    expect(
      degradeVisualProfile({ effectsQuality: "reduced", dpr: REDUCED_EFFECTS_MAX_DPR }, false),
    ).toEqual({
      effectsQuality: "off",
    ...
    expect(
      degradeVisualProfile({ effectsQuality: "off", dpr: PERFORMANCE_FALLBACK_DPR }, false),
    ).toEqual({
      effectsQuality: "off",
  ...
  it("improves quality conservatively based on motion settings", () => {
    expect(
      improveVisualProfile({ effectsQuality: "off", dpr: PERFORMANCE_FALLBACK_DPR }, false),
    ).toEqual({
      effectsQuality: "reduced",
      dpr: REDUCED_EFFECTS_MAX_DPR,
    });
    ...
    expect(
      improveVisualProfile({ effectsQuality: "reduced", dpr: REDUCED_EFFECTS_MAX_DPR }, false),
    ).toEqual({
      effectsQuality: "full",
      dpr: FULL_EFFECTS_MAX_DPR,
    });
    ...
    expect(
      improveVisualProfile({ effectsQuality: "reduced", dpr: REDUCED_MOTION_MAX_DPR }, true),
    ).toEqual({
      effectsQuality: "reduced",
      dpr: REDUCED_MOTION_MAX_DPR,
    });
  ...
  it("clamps existing profiles to reduced-motion limits without increasing dpr", () => {
    ...
    expect(
      clampVisualProfile({ effectsQuality: "off", dpr: PERFORMANCE_FALLBACK_DPR }, true),
    ).toEqual({
      effectsQuality: "off",
      dpr: PERFORMANCE_FALLBACK_DPR,
    });
