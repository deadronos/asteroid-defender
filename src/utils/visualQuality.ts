...
export function getMaxDprForEffectsQuality(quality: EffectsQuality, reducedMotion: boolean): number {
...
export function createVisualProfile(quality: EffectsQuality, reducedMotion: boolean): VisualProfile {
    const normalizedQuality = normalizeEffectsQuality(quality, reducedMotion);
...
export function improveVisualProfile(current: VisualProfile, reducedMotion: boolean): VisualProfile {
...
export function degradeVisualProfile(current: VisualProfile, reducedMotion: boolean): VisualProfile {
    const normalizedQuality = normalizeEffectsQuality(current.effectsQuality, reducedMotion);
